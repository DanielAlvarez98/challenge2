...
let palabras=[localStorage.getItem("daniel"),"QATAR","ALEMANIA","DINAMARCA","BRASIL","FRANCIA", "BELGICA","CROACIA","ESPAÑA","SERBIA","INGLATERRA","SUIZA","HOLANDA","ARGENTINA","IRAN","JAPON","ECUADOR","URUGUAY","MEXICO","GHANA","SENEGAL","POLONIA","PORTUGAL","TUNEZ","MARRUECOS","CAMERUN","PERU","WALES",]
var juego = null
...
function dibujar(juego){
    var $elem
    $elem = $html.hombre
    $elem.src="./img/ahorcado/0" +juego.estado +".png"
